...
const mobileLinks = [
  ...
  { href: "/time-blocks", label: "Blocks", mark: "TB" },
    ...
    <div className="app-shell-container mx-auto min-h-screen max-w-7xl px-3 pb-24 pt-3 sm:px-6 sm:py-6 lg:px-8">
      <header className="app-shell-header sticky top-0 z-40 mb-4 overflow-hidden rounded-2xl border bg-card/90 p-3 shadow-sm backdrop-blur sm:static sm:mb-6 sm:flex sm:flex-wrap sm:items-center sm:justify-between sm:p-4">
        ...
        <div className="min-w-0">
          <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-muted-foreground sm:hidden">Command Center</p>
      ...
      {children}
      <nav className="fixed inset-x-3 bottom-3 z-50 grid grid-cols-4 gap-1 rounded-[1.35rem] border border-white/10 bg-slate-950/92 p-1.5 text-white shadow-[0_18px_70px_rgba(2,6,23,0.5)] backdrop-blur sm:hidden">

...
export type Capability = "REPOSITORY_READ" | "REPOSITORY_CHANGE" | "RUN_TESTS" | "CODEX_IMPLEMENTATION" | "CODEX_REVIEW" | "RYKAS_OPERATIONS_READ";
...
export type WorkerResult = { status: "SUCCEEDED" | "FAILED"; summary: string; filesChanged: string[]; testsRun: string[]; testResults: string;
  ...
  externalThreadId?: string; externalRunId?: string; providerIdentifier?: string; modelIdentifier?: string; rykasTruthResult?: RykasTruthResult };
